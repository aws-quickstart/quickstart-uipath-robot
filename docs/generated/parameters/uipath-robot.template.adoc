...
(`VPCID`)|`**__Requires input__**`|ID of the VPC where the UiPath Robot is created.|Private subnet IDs
(`PrivateSubnetID`)|`**__Requires input__**`|Private subnet with UiPath Robot.|Public subnet IDs
